...
// Package awsnukemod contains copies of code from the aws-nuke project
// https://github.com/rebuy-de/aws-nuke and modifications to it. In order to
// integrate with reaper, the resources observed by aws-nuke needed to be
...
// to be split into separate steps. Hence, the mods.go adds GatherResources()
// and Delete() to Nuke.
...
// ApplyRetentionFilter() is introduced on Nuke. This allows applying the filter
